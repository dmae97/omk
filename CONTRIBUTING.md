...
If you use an agent, run it from the `open-multi-agent-kit` root directory so it picks up `AGENTS.md` automatically. Your agent must follow the rules and guidelines in that file.

...
interface StderrArtifactOptions {
...
function stderrArtifactOptions(input: StderrArtifactOptions): StderrArtifactOptions {
  return input;
}

function privateStderrRetentionEnabled(env?: Record<string, string | undefined>): boolean {
...
function sanitizeAgentRunResult(result: AgentRunResult, options: StderrArtifactOptions = {}): AgentRunResult {

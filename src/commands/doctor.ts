...
import {
  createDoctorFixPlan,
  addDoctorFixOperation,
  recordDoctorFix,
  createDoctorFixReport,
  summarizeDoctorChecks,
  buildDoctorPostFixCheck,
  type DoctorFixSeverity,
  type DoctorFixLevel,
  type DoctorFixSafetyTier,
  type DoctorFixOperationStatus,
  type DoctorFixOperation,
  type DoctorCheckSummary,
  type DoctorPostFixCheck,
  type DoctorFixPlan,
  type DoctorFixReport,
  type DoctorFixContext,
} from "./doctor/fix-plan.js";

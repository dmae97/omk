...
import { renderCockpit as renderModularCockpit } from "./cockpit/render.js";
...
export interface CockpitRenderOptions {
  ...
  section?: "agents" | "todos" | "mcp" | "all";
  events?: "on" | "off";
  view?: "rail" | "panel" | "json" | "dashboard" | string;
}
...
export async function renderCockpit(options: CockpitRenderOptions = {}) {
  if (options.view === "rail") {
    return renderModularCockpit({
      ...(options as Omit<Parameters<typeof renderModularCockpit>[0], "view">),
      view: "rail",
    });
  }

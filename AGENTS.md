...
- Internal (from issues): `Fixed foo bar ([#123](https://github.com/earendil-works/omk-mono/issues/123))`
- External contributions: `Added feature X ([#456](https://github.com/earendil-works/omk-mono/pull/456) by [@username](https://github.com/username))`

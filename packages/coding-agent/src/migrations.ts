...
const MIGRATION_GUIDE_URL =
	"https://github.com/earendil-works/omk-mono/blob/main/packages/coding-agent/CHANGELOG.md#extensions-migration";
const EXTENSIONS_DOC_URL =
	"https://github.com/earendil-works/omk-mono/blob/main/packages/coding-agent/docs/extensions.md";
 ...
 *
 * See: https://github.com/earendil-works/omk-mono/issues/320
 */

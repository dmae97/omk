...
export const NEO_SKILL_NAMES = [
	"omk-computeruse", "omk-browser", "omk-site", "omk-research", "omk-code-review", "omk-mcp-setup",
] as const;
...
export const NEO_MCP_PRESETS: readonly NeoMcpPreset[] = [
	{
		...
		notice: "Opt-in executable download and website access. A compatible browser is required. Profile isolation is not OS isolation. Sandbox failure must not trigger --no-sandbox fallback. No personal browser attachment.",
	},
	{
		id: "context7",
		...
		notice: "Opt-in executable download and external documentation queries. Do not send private code or secrets. Authentication and limits are user-specific; no credential is bundled.",
	},
];
...
export function neoMcpConfig(ids: readonly string[], enabled: boolean): {

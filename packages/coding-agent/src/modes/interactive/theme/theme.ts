...
const THEME_NAME_ALIASES: Record<string, string> = {
	...
	freedom: "omk-freedom-grid",
	"freedom-grid": "omk-freedom-grid",
	"cyber-freedom": "omk-freedom-grid",
	"omk-freedom": "omk-freedom-grid",
	blackboard: "omk-blackboard",
	chalk: "omk-blackboard",
	"slate-light": "omk-slate-light",
	paper: "omk-slate-light",
	"control-panel": "omk-control-panel",
	"omk-control-ansi": "omk-control-panel",
	"omk-neon": "omk-neon-ops",
	"neon-ops": "omk-neon-ops",
...
function getBuiltinThemes(): Record<string, ThemeJson> {
	if (!BUILTIN_THEMES) {
		BUILTIN_THEMES = {
			...
			"omk-freedom-grid": readBuiltinTheme("omk-freedom-grid.json"),
			"omk-blackboard": readBuiltinTheme("omk-blackboard.json"),
			"omk-slate-light": readBuiltinTheme("omk-slate-light.json"),
			"omk-neon-ops": readBuiltinTheme("omk-neon-ops.json"),

...
const RAMP_STOPS = [
	{ pos: 0, l: 0.87, c: 0.149, h: 194.8 },
	{ pos: 0.33, l: 0.724, c: 0.146, h: 255.1 },
	{ pos: 0.66, l: 0.735, c: 0.15, h: 295.2 },
	{ pos: 1, l: 0.74, c: 0.23, h: 334.9 },
] as const;
...
export function shouldGradient(options: {
	...
	return modeSupportsGradient && options.isTTY && !options.noColor && options.expanded && options.width >= 32;
}

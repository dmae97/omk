...
export const SETTINGS_SCHEMA = {
	...
	"edit.hashlineAutoDropPureInsertDuplicates": {
		...
		ui: {
			...
			description:
				"Drop payload lines that duplicate adjacent file context — 2+-line context echoes on pure inserts, and a single boundary line at either edge of an `A-B:` replacement",
		},
	},

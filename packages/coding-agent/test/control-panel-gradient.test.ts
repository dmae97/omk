...
describe("control-panel static gradient math", () => {
	...
	test("colorAt is deterministic, finite, clamped, and anchors cyan to magenta diagonally", () => {
		...
		expect(colorDistance(bottomLeft, { r: 0, g: 242, b: 242 })).toBeLessThan(24);
		expect(colorDistance(topRight, { r: 253, g: 101, b: 227 })).toBeLessThan(32);
	});
});
